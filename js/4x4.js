...
function verificarVitoria() {
    ...
    for (var i = 0; i < tamanhoTabuleiro; i++) {
        if (verificarCelulas('c' + i + '0', 'c' + i + '1', 'c' + i + '2', 'c' + i + '3')) {
     ...
     for (var j = 0; j < tamanhoTabuleiro; j++) {
        if (verificarCelulas('c0' + j, 'c1' + j, 'c2' + j, 'c3' + j)) {
            alert("Vitória! Jogador " + jogadorAtual + " ganhou!");
            reiniciarJogo();
            return;
        }
    ...
    // Verificar diagonais
    if (verificarCelulas('c00', 'c11', 'c22', 'c33') || verificarCelulas('c03', 'c12', 'c21', 'c30')) {
        alert("Vitória! Jogador " + jogadorAtual + " ganhou!");
            reiniciarJogo();
            return;
        }
...
function verificarCelulas(idCelula1, idCelula2, idCelula3, idCelula4) {
    ...
    return (celula1 !== '' && celula1 === celula2 && celula2 === celula3 && celula3 === celula4);
}
