...
function verificarVitoria() {
    ...
    for (var i = 0; i < tamanhoTabuleiro; i++) {
        if (verificarCelulas('c' + i + '0', 'c' + i + '1', 'c' + i + '2', 'c' + i + '3',  'c' + i + '4', 'c' + i + '5', 'c' + i + '6' , 'c' + i + '7' , 'c' + i + '8', 'c' + i + '9')) {
     ...
     for (var j = 0; j < tamanhoTabuleiro; j++) {
        if (verificarCelulas('c0' + j, 'c1' + j, 'c2' + j, 'c3' + j,  'c4' + j,  'c5' + j,  'c6' + j,  'c7' + j,  'c8' + j,  'c9' + j)) {
            alert("Vitória! Jogador " + jogadorAtual + " ganhou!");
            reiniciarJogo();
            return;
        }
    ...
    // Verificar diagonais
    if (verificarCelulas('c00', 'c11', 'c22', 'c33', 'c44', 'c55', 'c66' , 'c77', 'c88', 'c99') || verificarCelulas('c09', 'c18', 'c27', 'c36', 'c45', 'c54', 'c63', 'c72', 'c81', 'c90')) {
        alert("Vitória! Jogador " + jogadorAtual + " ganhou!");
            reiniciarJogo();
            return;
        }
...
function verificarCelulas(idCelula1, idCelula2, idCelula3, idCelula4, idCelula5, idCelula6, idCelula7, idCelula8, idCelula9, idCelula10) {
    ...
    var celula10 = document.getElementById(idCelula10).innerHTML;

    return (celula1 !== '' && celula1 === celula2 && celula2 === celula3 && celula3 === celula4 && celula4 === celula5 && celula5 === celula6 && celula6 === celula7 && celula7 === celula8 && celula8 === celula9 && celula9 === celula10);
}
